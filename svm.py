...
def run_svm(train_file, test_file, radius, N):
    ...
    predictions, accuracy = predict(alpha_avg, train_examples, train_labels, test_examples, test_labels, radius)
    print('radius: ', radius)
    print('true negative: ', accuracy[0][0])
    print('false positive: ', accuracy[0][1])
    print('true positive: ', accuracy[1][1])
    print('false negative: ', accuracy[1][0])
    print()
    return accuracy
